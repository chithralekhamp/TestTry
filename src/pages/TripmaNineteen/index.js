              ...
              >
                <Column className="flex flex-col items-center justify-start sm:mb-[41px] md:mb-[52px] mb-[77px] md:mt-[101px] mt-[147px] sm:mt-[78px] sm:px-[0] w-[100%]">
                  ...
                  >
                    ...
                    <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly my-[0] p-[4px] w-[100%]">
                      <Stack className="bg-gradient4  h-[40px] sm:p-[3px] md:p-[4px] p-[6px] relative rounded-radius4 w-[16%]">
                        <Img
              ...
              <Column className="flex flex-col items-center overflow-auto sm:px-[0] w-[100%]">
                  ...
                  <Column className="flex flex-col items-center justify-center sm:mb-[37px] md:mb-[48px] mb-[70px] ml-[4px] sm:mx-[0] md:p-[5px] p-[8px] sm:px-[0] sm:py-[4px] rounded-radius8 sm:w-[100%] w-[49%]">
                    ...
                    <Column className="flex flex-col justify-start sm:mb-[12px] md:mb-[16px] mb-[24px] md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[85%]">
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[75%]">
                        ...
                        <Text
                          className="bg-gradient3  font-bold md:ml-[11px] ml-[16px] sm:ml-[8px] sm:px-[3px] md:px-[4px] px-[6px] py-[2px] rounded-radius4 text-white_A700 w-[auto]"
                          as="h4"
                          variant="h4"
                        >
                          Selected
                ...
                <Column className="bg-gray_52 flex flex-col items-center justify-start w-[100%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[11px] p-[16px] sm:px-[15px] sm:py-[8px] w-[100%]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:ml-[5px] ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                      <Column className="flex flex-col sm:mx-[0] md:p-[5px] p-[8px] sm:px-[0] sm:py-[4px] sm:w-[100%] w-[55%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 w-[auto]"
                          as="h4"
                          variant="h4"
                      ...
                      <Column className="flex flex-col md:ml-[11px] ml-[16px] sm:mx-[0] md:p-[5px] p-[8px] sm:px-[0] sm:py-[4px] sm:w-[100%] w-[41%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 w-[auto]"
                          as="h4"
                          variant="h4"
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center md:ml-[11px] ml-[16px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[49%]">
                      <Button
                      ...
                      <Button
                        className="cursor-pointer font-normal min-w-[50%] md:ml-[11px] ml-[16px] sm:ml-[8px] not-italic text-[16px] text-center text-gray_51 w-[max-content]"
                        shape="RoundedBorder4"
...
export default TripmaNineteenPage;
