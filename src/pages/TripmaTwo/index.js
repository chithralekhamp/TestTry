    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-end mx-[auto] w-[100%]">
        ...
        <Stack className="h-[788px] relative w-[100%]">
          <Column
            className="absolute bg-cover bg-no-repeat bottom-[0] flex flex-col justify-end sm:pt-[15px] md:pt-[33px] pt-[48px] sm:px-[15px] md:px-[33px] px-[48px] w-[100%]"
            style={{ backgroundImage: "url('images/defaultNoData.png')" }}
          >
            <Column className="flex flex-col items-center justify-start sm:mt-[23px] md:mt-[30px] mt-[45px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[95%]">
              <Img
                src="images/img_herotextgradi.png"
                className="max-w-[100%] sm:w-[100%] w-[60%]"
                alt="HeroTextGradi"
              />
              <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end ml-[auto] sm:mt-[25px] md:mt-[33px] mt-[48px] sm:mx-[0] outline outline-[1px] outline-bluegray_100 rounded-radius4 shadow-bs sm:w-[100%] w-[95%]">
                <List
                ...
                <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center ml-[1px] sm:mx-[0] sm:p-[4px] md:p-[5px] p-[8px] rounded-radius4 sm:w-[100%] w-[21%]">
                  <Img
              ...
              <Column className="bg-gray_50 border border-indigo_A200 border-solid flex flex-col items-center justify-start mt-[115px] sm:mt-[61px] md:mt-[79px] sm:mx-[0] md:p-[11px] sm:p-[15px] p-[16px] rounded-radius8 sm:w-[100%] w-[24%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[98%]">
                  ...
                  <Img
                    ...
                    className="flex-shrink-0 sm:h-[18px] md:h-[23px] h-[32px] max-w-[100%] ml-[10px] sm:ml-[5px] md:ml-[6px] sm:w-[17px] md:w-[22px] w-[32px]"
                    alt="close One"
                  />
                </Row>
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[12px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
                  <Button
                    className="cursor-pointer font-normal min-w-[51%] not-italic text-[14px] text-center text-gray_51 w-[max-content]"
                    shape="RoundedBorder4"
                    size="sm"
                    variant="FillIndigoA200"
                  >
                  ...
                  <Column className="flex flex-col items-center ml-[4px] sm:mx-[0] md:p-[5px] p-[8px] sm:px-[0] sm:py-[4px] rounded-radius4 sm:w-[100%] w-[48%]">
                    <Text
