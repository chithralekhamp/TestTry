      ...
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[21px] md:mt-[27px] mt-[40px] w-[100%]">
            ...
            <Text
              className="font-semibold sm:ml-[40px] md:ml-[52px] ml-[76px] sm:mt-[25px] md:mt-[33px] mt-[48px] text-bluegray_500 w-[auto]"
              as="h2"
              variant="h2"
            >
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1312px] md:ml-[44px] ml-[auto] mr-[auto] md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col items-end justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[67%]">
                    ...
                    <div className="overflow-x-auto w-[100%]">
                      <Stack className="h-[440px] relative rounded-radius8 w-[100%]">
                        ...
                        <Column className="absolute flex flex-col items-center justify-start top-[0] w-[100%]">
                          <Row className="bg-gray_50 border border-indigo_A200 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center p-[4px] rounded-radius4 w-[100%]">
                            <Img
                            ...
                            <Column className="flex flex-col items-center md:ml-[5px] ml-[8px] sm:mx-[0] md:p-[5px] p-[8px] sm:px-[0] sm:py-[4px] sm:w-[100%] w-[92%]">
                              ...
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[98%]">
                                ...
                                <Text
                                  className="font-normal sm:ml-[33px] md:ml-[43px] ml-[63px] not-italic text-bluegray_400 w-[auto]"
                                  as="h3"
                                  variant="h3"
                                >
                                  value
                                ...
                                <Text
                                  className="font-normal sm:ml-[105px] md:ml-[136px] ml-[198px] not-italic text-bluegray_400 w-[auto]"
                                  as="h3"
                                  variant="h3"
                                >
                                  2h 45m in HNL
              ...
              <Column className="flex flex-col justify-start md:ml-[27px] ml-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[31%]">
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[56%] md:ml-[111px] ml-[162px] sm:ml-[86px] md:mr-[11px] mr-[16px] sm:mr-[8px] sm:mt-[17px] md:mt-[22px] mt-[32px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                  shape="RoundedBorder4"
                  variant="FillIndigoA200"
                >
            ...
            <div className="md:ml-[44px] ml-[64px] sm:mt-[25px] md:mt-[33px] mt-[48px] sm:mx-[0] overflow-x-auto sm:px-[0] sm:w-[100%] w-[61%]">
