...
import { Column, Row, Img, Text, Button, Input, Line, Stack } from "components";

const TripmaSevenPage = () => {
  return (
    <>
        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[29px] md:mt-[38px] mt-[56px] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between max-w-[1248px] md:ml-[66px] ml-[auto] mr-[auto] sm:mt-[12px] md:mt-[15px] mt-[23px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                  <Input
                    className="font-normal not-italic p-[0] text-[18px] placeholder:text-black_900 text-black_900 w-[100%]"
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1248px] md:ml-[66px] ml-[auto] mr-[auto] sm:mt-[11px] md:mt-[14px] mt-[21px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[3px] md:mt-[4px] mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[15%]">
                ...
                <Text
                  className="font-normal sm:ml-[4px] md:ml-[5px] ml-[8px] not-italic text-bluegray_500 w-[auto]"
                  as="h3"
                  variant="h3"
                >
                  Same as Passenger 1
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1248px] md:ml-[66px] ml-[auto] mr-[auto] sm:mt-[12px] md:mt-[16px] mt-[24px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[55%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
                  <Input
                    className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 underline w-[100%]"
                    wrapClassName="sm:mx-[0] sm:w-[100%] w-[49%]"
                    type="email"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[4px] md:mt-[6px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[69%]">
                  <Text
                    className="font-semibold mb-[1px] sm:mt-[3px] md:mt-[4px] mt-[6px] text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
                    Sophia Knowles
                  </Text>
                  <Stack className="bg-gray_51 h-[32px] sm:ml-[111px] md:ml-[144px] ml-[210px] relative rounded-radius4 sm:w-[17px] md:w-[22px] w-[32px]">
                    <Img
                  ...
                  <Text
                    className="font-normal sm:ml-[12px] md:ml-[16px] ml-[24px] sm:my-[3px] md:my-[4px] my-[6px] not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
                    1
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[39px] md:mt-[50px] mt-[74px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                  ...
                  <Button
                    className="cursor-pointer font-normal min-w-[43%] sm:ml-[12px] md:ml-[16px] ml-[24px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                    shape="RoundedBorder4"
                    variant="FillIndigoA200"
                  >
                    Select seats
              ...
              <Column className="flex flex-col font-roboto justify-start sm:mt-[12px] md:mt-[15px] mt-[23px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[31%]">
                <Stack className="h-[482px] relative w-[100%]">
                  <Img
                    src="images/img_luggage_448X374.svg"
...
export default TripmaSevenPage;
