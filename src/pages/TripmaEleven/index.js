        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[29px] md:mt-[38px] mt-[56px] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1248px] md:ml-[66px] ml-[auto] mr-[auto] md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              ...
              <Column className="flex flex-col items-end justify-start sm:mt-[38px] md:mt-[50px] mt-[73px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[33%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between max-w-[1232px] md:ml-[66px] ml-[auto] mr-[auto] sm:mt-[4px] md:mt-[6px] mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Text
                className="font-semibold sm:mt-[16px] md:mt-[21px] mt-[31px] text-bluegray_500 w-[auto]"
                as="h2"
                variant="h2"
              >
                Create an account
              ...
              <Button
                className="cursor-pointer font-normal mb-[3px] min-w-[15%] not-italic text-[18px] text-bluegray_400 text-center w-[max-content]"
                shape="RoundedBorder4"
            ...
            <CheckBox
              className="font-normal sm:ml-[51px] md:ml-[66px] ml-[96px] sm:mt-[14px] md:mt-[19px] mt-[28px] not-italic sm:pl-[4px] md:pl-[5px] pl-[8px] text-[16px] text-bluegray_500"
            ...
            <Input
              className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_400 text-bluegray_400 w-[100%]"
              wrapClassName="md:ml-[66px] md:mt-[16px] ml-[96px] mt-[24px] sm:mt-[12px] sm:mx-[0] sm:w-[100%] w-[34%]"
              type="password"
              name="basetextin Five"
              placeholder="Password"
            ></Input>
            <Column className="flex flex-col items-center justify-start max-w-[488px] md:ml-[66px] ml-[auto] mr-[auto] sm:mt-[21px] md:mt-[27px] mt-[40px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[388px] md:ml-[66px] ml-[auto] mr-[auto] sm:mt-[29px] md:mt-[38px] mt-[56px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              ...
              <Button
                className="cursor-pointer font-normal min-w-[45%] sm:ml-[12px] md:ml-[16px] ml-[24px] not-italic text-[18px] text-bluegray_400 text-center w-[max-content]"
                shape="RoundedBorder4"
                variant="OutlineBluegray400"
              >
                Confirm and pay
...
export default TripmaElevenPage;
